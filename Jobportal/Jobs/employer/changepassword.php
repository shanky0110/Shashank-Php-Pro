...
if(count($_POST) <> 0)
{
	...
	{
		$rs0=mysql_fetch_array(mysql_query("Select * from sbjbs_employers 
		where sb_id=".$_SESSION["sbjbs_emp_userid"]. " and sb_password='$sbcurrent_pwd'"));
	...
	if($errcnt==0)
	{
			mysql_query("Update sbjbs_employers SET sb_password='$sbnew_pwd' where sb_id=".$_SESSION["sbjbs_emp_userid"]);
