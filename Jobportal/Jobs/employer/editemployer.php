...
//die();
	...
	{
		header("Location: personal_confirm_mem.php?err=editemployer&errmsg=".urlencode("Sorry, no updations carried out."));
		die();
	}
 }			//end if-errcnt==0
}			//end if count-post
...
<form name="form1" method="post" action="editemployer.php" onSubmit="return validate(this);">
