...
//	die();
		...
		//mail ends here
		header("Location: members.php?msg=".urlencode("New member has been added"));
		die();
		}
		else
		{
			header("Location: members.php?msg=".urlencode("Some error occurred, please try again."));
			die();
		}
	}			//end if-errcnt==0
}			//end if count-post
...
<form name="form1" method="post" action="addmember.php" onSubmit="return validate(this);">
  <table width="90%" border="0" align="center" cellpadding="2" cellspacing="5" class="onepxtable">
    <tr class="titlestyle"> 
      <td colspan="3">&nbsp;Add New Job Seeker</td>
    </tr>
    <tr valign="top"> 
