...
if(count($_POST)>0)
{
		...
		{
			$errmsg[$errcnt]="Please specify Skill.";
			$errcnt++;
		}
		else
		{
			$rst=mysql_fetch_array(mysql_query("select * from sbjbs_skills where
			sb_name='$sb_name'"));
			if($rst)
			{
				$errmsg[$errcnt]="Skill already exists.";
				$errcnt++;
			}
		}
...
if($errcnt==0)
{
    mysql_query("insert into sbjbs_skills (sb_name) values ('$sb_name')");
	if(mysql_affected_rows()>0)
	{
	header("Location: "."manage_skill.php?msg=".urlencode("Skill has been added."));
	die();
	}
	else
	{
	header("Location: "."manage_skill.php?msg=".urlencode("Some error occurred, please try again."));
	die();
	}
}
}
...
<table width="90%" height="20" border="0" align="center" cellpadding="0" cellspacing="0">
		  ...
		  onSubmit="return Validator();" >
            <tr align="left" class="row1"> 
              <td height="25" colspan="3" bgcolor="#004080"><font size="3" face="Arial, Helvetica, sans-serif"><font color="#FFFFFF" size="2"><strong>&nbsp;Add 
                Skill</strong></font></font></td>
            </tr>
            <tr class="row1"> 
              <td width="40%" align="right" bgcolor="#F5F5F5"> <div align="right"><font size="2" face="Arial, Helvetica, sans-serif"><strong>Skill:</strong></font></div></td>
  ...
  <tr>
    <td colspan="2" align="left" valign="top"><table width="100%" border="0" cellspacing="10" cellpadding="2">
        <tr> 
          <td height="25" colspan="2" bgcolor="#004080"><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif"><strong>&nbsp;Skills</strong></font></td>
        </tr>
        <?
					  $loc_query=mysql_query("select * from sbjbs_skills order by sb_name");
        ...
        <tr> 
          ...
          <td valign="top"><font size="1" face="Arial, Helvetica, sans-serif">&nbsp;[&nbsp;<a href="edit_skill.php?id=<? echo $loc["sb_id"];?>" ><font size="1" face="Arial, Helvetica, sans-serif">Edit</font></a>&nbsp;]&nbsp;&nbsp;[&nbsp;<a href="delete_skill.php?id=<? echo $loc["sb_id"];?>" onClick="javascript: return confirm('Do you really want to remove the Skill?');">Delete</a>&nbsp;]&nbsp;</font></td>
        </tr>
        <?
					  }
                    ?>
