...
$sql0="select *,UNIX_TIMESTAMP(sb_signup_on) as signup, UNIX_TIMESTAMP(sb_last_login) as lastlogin from sbjbs_employers where 1  ";
...
?>
				  ...
				  echo sb_date($rs_query["signup"]);
				   ...
				   ?>
                            ...
                            <tr valign="top"> 
                              ...
                              <td width="563"><strong><font color="#333333" size="1" face="Arial, Helvetica, sans-serif"> 
                                </font></strong> 
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr> 
                                    <td width="50%"><strong><font color="#333333" size="1" face="Arial, Helvetica, sans-serif"> 
                                      <? 
				  echo $rs_query["sb_firstname"]." ".$rs_query["sb_lastname"];
				  
				   ?>
                                      </font></strong></td>
                                    <td><font size="1" face="Arial, Helvetica, sans-serif">&nbsp;[&nbsp;<a href="edit_employer.php?id=<? echo $rs_query["sb_id"];?>" >Edit 
                                      Profile</a>&nbsp;]&nbsp;&nbsp;[&nbsp;<a href="delete_employer.php?id=<? echo $rs_query["sb_id"];?>" onClick="javascript: return confirm('All the jobs and other information related to the employer will be deleted.\n\nDo you really want to delete the employer?');">Delete</a>&nbsp;]&nbsp;<?php                echo "[&nbsp;<a href='suspend_employer.php?sb_id=".$rs_query["sb_id"]."'>";
						   ...
						   echo "[&nbsp;<a href='searchable.php?sb_id=".$rs_query["sb_id"]."'>";
							if($rs_query["sb_search_allowed"]=="no")
							{ echo "Allow Search";}
							else
							{ echo "Prohibit Search";}
							 echo "</a>&nbsp;]&nbsp;";
									  ?></font></td>
                                  </tr>
                                  <tr> 
				  ...
				  echo $rs_query["sb_addr1"];
				   ...
				   ?>
                                    ...
                                    <td><font size="2" face="Arial, Helvetica, sans-serif"><font size="1">&nbsp;[&nbsp;<a href="jobs.php?sb_id=<? echo $rs_query["sb_id"];?>">Jobs</a>&nbsp;]</font><font size="2" face="Arial, Helvetica, sans-serif"><font size="1">&nbsp;[&nbsp;<a href="view_transactions.php?sb_id=<? echo $rs_query["sb_id"];?>">Billing 
                                      Transactions</a>&nbsp;]</font><font size="2" face="Arial, Helvetica, sans-serif"><font size="2" face="Arial, Helvetica, sans-serif"><font size="1">&nbsp;[&nbsp;<a href="edit_premium.php?sb_id=<? echo $rs_query["sb_id"];?>">Edit Premium</a>&nbsp;]</font></font></font></font></font></td>
                                  </tr>
                                  <tr> 
                                    <td><strong><font color="#333333" size="1" face="Arial, Helvetica, sans-serif"> 
                                      <? 
				  ...
				  echo  $rs_query["sb_zip"].", ".$rs_query["sb_city"];
				   ?>
                                    ...
                                    <td><font size="2" face="Arial, Helvetica, sans-serif"><font size="2" face="Arial, Helvetica, sans-serif"><font size="1">&nbsp;[&nbsp;<a href="manage_applications.php?sb_uid=<? echo $rs_query["sb_id"];?>">Applications</a>&nbsp;]</font></font></font></td>
                                  </tr>
                                  <tr valign="top"> 
                                    <td><strong><font color="#333333" size="1" face="Arial, Helvetica, sans-serif"> 
                                      <? 
				  ...
				  echo " ".$country["country"];
				   ...
				   ?>
                                    ...
                                    <td height="25"><font size="2" face="Arial, Helvetica, sans-serif"><font size="1">&nbsp;[&nbsp;<a href="manage_profiles.php?sb_id=<?php echo $rs_query["sb_id"]; ?>" >Company Profiles</a>&nbsp;]</font></font></td>
                                  </tr>
                                </table></td>
                            </tr>
                          </table></td>
