...
///////////////////////////////////////////////////////////////////////////////
		...
		mysql_query("update	sbjbs_resume_skills set sb_skill_id=$type_id where sb_skill_id=$id");
		
			
		mysql_query("delete from sbjbs_skills where sb_id=".$_REQUEST["id"]);
		header("Location: "."manage_skill.php?msg=".urlencode("Skill has been removed from the list."));
		die();
		}
...
{
$id=$_REQUEST["id"];
$cur=mysql_fetch_array(mysql_query("select * from sbjbs_skills where sb_id=$id"));
$num=mysql_num_rows(mysql_query("select sb_id from sbjbs_job_skls where sb_sid=$id"));
$num+=mysql_num_rows(mysql_query("select sb_id from sbjbs_resume_skills where sb_skill_id=$id"));
?>
          ...
          <table width="100%" border="0" cellspacing="10" cellpadding="2">
            <tr align="left" bgcolor="#004080"> 
              <td height="25" colspan="2"><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif"><strong>&nbsp;Delete 
                Skill&nbsp; <font color="#FFCC00"><? echo $cur["sb_name"];?></font></strong></font></td>
            </tr>
            <tr align="center" bgcolor="#F5F5F5"> 
              <td colspan="2"><font size="1" face="Arial, Helvetica, sans-serif">Total 
                ...
                Skill <strong><? echo $cur["sb_name"];?></strong>.Skill of existing listings will be changed to Alternate Skill.</font></td>
            </tr>
            <tr> 
              ...
              <td><font size="2" face="Arial, Helvetica, sans-serif"> 
                <select name="type_id">
                  <?
			  $cats=mysql_query("select * from sbjbs_skills where sb_id<>$id ");
