...
///////////////////////////////////////////////////////////////////////////////
		...
		/*changing profiles */
		mysql_query("update	sbjbs_resume_language set sb_language_id=$type_id where sb_language_id=$id");
		
			
		mysql_query("delete from sbjbs_languages where sb_id=".$_REQUEST["id"]);
		header("Location: "."manage_language.php?msg=".urlencode("Language has been removed from the list."));
		die();
		}
...
{
$id=$_REQUEST["id"];
$cur=mysql_fetch_array(mysql_query("select * from sbjbs_languages where sb_id=$id"));
$num=mysql_num_rows(mysql_query("select sb_id from sbjbs_resume_language where sb_language_id=$id"));
?>
          ...
          <table width="100%" border="0" cellspacing="10" cellpadding="2">
            <tr align="left" bgcolor="#004080"> 
              <td height="25" colspan="2"><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif"><strong>&nbsp;Delete 
                Language&nbsp; <font color="#FFCC00"><? echo $cur["sb_name"];?></font></strong></font></td>
            </tr>
            <tr align="center" bgcolor="#F5F5F5"> 
              <td colspan="2"><font size="1" face="Arial, Helvetica, sans-serif">Total 
                ...
                Language <strong><? echo $cur["sb_name"];?></strong>.Language of existing listings will be changed to Alternate Language.</font></td>
            </tr>
            <tr> 
              <td width="40%" align="right" bgcolor="#F5F5F5"><strong><font size="2" face="Arial, Helvetica, sans-serif">Alternate 
                Language:</font></strong></td>
              <td><font size="2" face="Arial, Helvetica, sans-serif"> 
                <select name="type_id">
                  <?
			  $cats=mysql_query("select * from sbjbs_languages where sb_id<>$id ");
