...
if($errcnt==0)
{
    ...
    mysql_query("update sbjbs_skills set sb_name='$sb_name' 
	where sb_id=".$_POST["id"]);
	if(mysql_affected_rows()>0)
	{
	header("Location: "."manage_skill.php?msg=".urlencode("Skill has been updated."));
	die();
	}
	else
	{
	header("Location: "."edit_skill.php?id=".$_POST["id"]."&msg=".urlencode("Some error occurred. Please try again."));
	die();
	}
}
}
