...
//die();
		...
		mysql_query ("delete from sbjbs_signups where sb_email='$email'");	//let it delete the used record
...
//	die();
		...
		//mail ends here
		header("Location: employers.php?msg=".urlencode("New employer has been added"));
		die();
		}
		else
		{
			header("Location: employers.php?msg=".urlencode("Some error occurred, please try again."));
			die();
		}
	}			//end if-errcnt==0
}			//end if count-post
...
<form name="form1" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" onSubmit="return validate(this);">
  <table width="90%" border="0" align="center" cellpadding="2" cellspacing="5" class="onepxtable">
    <tr class="titlestyle"> 
      <td colspan="3">&nbsp;Add New Employer</td>
    </tr>
    <tr valign="top"> 
