...
if($errcnt==0)
{
    ...
    mysql_query("update sbjbs_languages set sb_name='$sb_name' 
	where sb_id=".$_POST["id"]);
	if(mysql_affected_rows()>0)
	{
	header("Location: "."manage_language.php?msg=".urlencode("Language has been updated."));
	die();
	}
	else
	{
	header("Location: "."edit_language.php?id=".$_POST["id"]."&msg=".urlencode("Some error occurred. Please try again."));
	die();
	}
}
}
